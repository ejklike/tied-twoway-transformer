...
def model_opts(parser):
    ...
    group.add('--share_relative_pos_embeddings', 
              '-share_relative_pos_embeddings', action='store_true',
              help='share_relative_pos_embeddings')
    ...
    group.add('--encoder_type', '-encoder_type', type=str, 
              default='transformer',
              choices=['rnn', 'mean', 'transformer'],
              help="Type of encoder layer to use. Non-RNN layers "
                   "are experimental. Options are "
                   "[rnn|mean|transformer].")
...
def translate_opts(parser):
    ...
    group.add('--num_experts', '-num_experts', default=1, type=int, 
              metavar='N', help='number of experts')
    group.add('--ngpu', '-ngpu', default=1, type=int,
              help="ngpu")
    ...
    group.add('--src_dir', '-src_dir', default="",
              help='Source directory for image or audio files')
    group.add('--tgt', '-tgt', default=None,
